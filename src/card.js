...
const data = [
  white(bold("          Work: ")) + gray("Developer Experience Engineer for Resend"),
  white(bold("     Home page: ")) + blue("https://philna.sh"),
  "",
  white(bold("       Twitter: ")) + gray("https://twitter.com/") + cyan(handle),
  white(bold("      Mastodon: ")) +
    gray("https://mastodon.social/") +
    magenta(`@${handle}`),
  white(bold("      LinkedIn: ")) +
    gray("https://www.linkedin.com/in/") +
    blue(handle),
  "",
  white(bold("           DEV: ")) + gray("https://dev.to/") + white(handle),
  white(bold("        Medium: ")) +
    gray("https://medium.com/") +
    white(`@${handle}`),
  "",
  white(bold("        GitHub: ")) + gray("https://github.com/") + white(handle),
  white(bold("      RubyGems: ")) +
    gray("https://rubygems.org/profiles/") +
    red(handle),
  white(bold("           npm: ")) +
    gray("https://www.npmjs.com/") +
    magenta(`~${handle}`),
  white(bold("Stack Overflow: ")) +
    gray("https://stackoverflow.com/users/28376/") +
    yellow(handle),
];
